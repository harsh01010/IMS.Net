    ...
    public class AuthAPIController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] UserRegistrationRequestDto requestDto)
        {
            ...
            else
            {
                ...
                bool status = await  emailSender.EmailSendAsync(new SendEmailRequestDto { Email= requestDto.Email,Subject= "Account Created at IMS Portal" ,Body = $"Congratulations {requestDto.Name} your account is successfully Registered"});
